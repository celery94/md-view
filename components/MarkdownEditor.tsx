  ...
  return (
    <>
      <textarea
        ...
        className="w-full flex-1 min-h-[20rem] md:min-h-0 resize-none overflow-auto bg-gradient-to-b from-white to-slate-50/30 p-6 sm:p-8 font-mono text-sm leading-relaxed text-slate-800 outline-none placeholder:text-slate-300 transition-all duration-200 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400/30 selection:bg-sky-100 selection:text-sky-900"
        spellCheck={false}
