  ...
  return (
    <>
      <textarea
        ...
        className="[font-family:var(--font-geist-mono)] w-full flex-1 min-h-[20rem] md:min-h-0 resize-none overflow-auto bg-gradient-to-b from-white to-slate-50/40 p-6 text-sm leading-relaxed text-slate-800 outline-none placeholder:text-slate-400 sm:p-8 transition-all duration-200 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-cyan-500/30 selection:bg-cyan-100 selection:text-cyan-900"
        spellCheck={false}
