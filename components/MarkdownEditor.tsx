  ...
  return (
    <>
      <textarea
        ...
        className="w-full flex-1 min-h-[20rem] md:min-h-0 resize-none overflow-auto bg-transparent p-6 sm:p-8 font-mono text-sm leading-relaxed text-slate-900 outline-none placeholder:text-slate-400 transition focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-400/40"
        spellCheck={false}
