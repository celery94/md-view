  ...
  return (
    <div className="relative inline-block group">
      <select
        ...
        className="appearance-none min-w-[140px] rounded-xl border border-slate-200/50 bg-white/50 pl-10 pr-10 py-3 text-sm font-semibold text-slate-700 shadow-[0_2px_8px_-2px_rgba(15,23,42,0.05)] backdrop-blur-md transition-all duration-300 hover:bg-white/80 hover:shadow-[0_8px_20px_-4px_rgba(15,23,42,0.12)] hover:scale-[1.02] hover:border-slate-300/60 active:scale-95 focus-visible:outline focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:ring-offset-2 focus-visible:ring-offset-white cursor-pointer"
