...
const THEME_PALETTES: Record<string, ThemePalette> = {
  ...
  'wechat-publish': {
    text: '#24292f',
    background: '#ffffff',
    bodyFont: '-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei","Noto Sans SC",Helvetica,Arial,sans-serif',
    bodyFontSize: '15px',
    bodyLineHeight: '1.6',
    link: '#0969da',
    linkExtra: { 'text-underline-offset': '2px' },
    inlineCodeColor: '#1f2328',
    inlineCodeBackground: 'rgba(175,184,193,0.2)',
    inlineCodeBorder: 'transparent',
    inlineCodeBorderRadius: '6px',
    inlineCodePadding: '0.2em 0.4em',
    inlineCodeFontSize: '85%',
    ...
    listMargin: '0.5em 0 0.75em 1.5em',
    strongExtra: { color: '#1f2328' },
    headingColor: '#1f2328',
