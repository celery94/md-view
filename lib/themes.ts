...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    classes: {
        container: 'h-full overflow-auto bg-gradient-to-b from-white to-emerald-50/25 border border-emerald-100/80 p-6 sm:p-10 shadow-[0_16px_34px_-28px_rgba(6,95,70,0.32)]',
